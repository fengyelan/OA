			...
			<table border="0" cellspacing="1" cellpadding="1" width="100%" id="InputArea">
				...
				<tr>
					...
					<td class="InputAreaBg"><div class="InputContent">
						<s:textfield name="title" cssClass="InputStyle" cssStyle="width:68%" value="回复：%{#topic.title}"/></div>
					</td>
				</tr>
				<tr height="240">
					<td class="InputAreaBg"><div class="InputTitle">内容</div></td>
					<td class="InputAreaBg"><div class="InputContent"><s:textarea name="content" cssStyle="width:650px;height:400px"></s:textarea></div></td>
				</tr>
				<tr height="30">
