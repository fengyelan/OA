...
<div id="MainArea">
	...
	<center>
		...
		<div class="ForumPageTableBorder dataContainer" datakey="replyList">
			...
			<!-- ~~~~~~~~~~~~~~~ 显示回复列表 ~~~~~~~~~~~~~~~ -->
			<s:iterator value="recordList" status="iteratorStatus">
			<div class="ListArea template">
				<table border="0" cellpadding="0" cellspacing="1" width="100%">
					...
					<tr><!--显示楼层等信息-->
						<td class="Footer" height="28" align="center" valign="bottom">
							<ul style="margin: 0px; width: 98%;">
								<li style="float: left; line-height:18px;"><font color=#C30000>[${iteratorStatus.count}楼]</font>
									${postTime}
								</li>
								<li style="float: right;"><a href="javascript:scroll(0,0)">
									<img border="0" src="${pageContext.request.contextPath}/style/images/top.gif" /></a>
		...
		<script type="text/javascript">
			function gotoPage(currentPage){
				 window.location.href = "topic_show.action?id=${id}&currentPage=" + currentPage;
			}
		</script>
			...
			<table border="0" cellspacing="1" width="98%" cellpadding="5" class="TableStyle">
				<tr height="30" class="Tint">
					...
					<td class="no_color_bg">
						<s:textfield name="title" cssClass="InputStyle" value="回复：%{#topic.title}"  cssStyle="width:68%" />
					</td>
				</tr>
