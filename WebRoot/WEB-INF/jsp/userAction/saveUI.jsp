                ...
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr><td width="100">所属部门</td>
                        <td>
                        	...
                        	name="departmentId" cssClass="SelectStyle" headerKey="" headerValue="===请您选择部门==="/>
                        </td>
                    </tr>
                    <tr><td>登录名</td>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    <tr>
						<td width="100">岗位</td>
                        <td><s:select list="#roleList" listKey="id" listValue="name" 
                        	name="roleIds" cssClass="SelectStyle"
